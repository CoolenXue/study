...
int OSA_ipcMbxSend(OSA_IpcMbxHndl *hndl, OSA_IpcMsgData *msgData, Uint32 msgSize)
{
  int status;
...
int OSA_ipcMbxRecv(OSA_IpcMbxHndl *hndl, OSA_IpcMsgData *msgData, Uint32 msgSize)
{
  int status;
